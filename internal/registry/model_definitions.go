...
func GetCodeBuddyModels() []*ModelInfo {
	...
	return []*ModelInfo{
		...
		},
		{
			...
			Description:         "DeepSeek V4 Pro via CodeBuddy — 1M context, top-tier reasoning",
		...
		},
		{
			...
			Description:         "DeepSeek V4 Flash via CodeBuddy — fast, economical variant",
			ContextLength:       1000000,
			MaxCompletionTokens: 32768,
			SupportedEndpoints:  []string{"/chat/completions"},
		},
		{
			...
			Description:         "MiniMax 3 via CodeBuddy — latest generation",
			ContextLength:       200000,
			MaxCompletionTokens: 32768,
			SupportedEndpoints:  []string{"/chat/completions"},
		},
...
func GetCodeBuddyIntlModels() []*ModelInfo {
	...
	return []*ModelInfo{
		...
		},
		{
			...
			Type:                     "codebuddy-intl",
			DisplayName:              "DeepSeek V4 Pro",
			Description:              "DeepSeek V4 Pro via CodeBuddy International — 1M context, top-tier reasoning",
			ContextLength:            1000000,
			MaxCompletionTokens:      32000,
		...
		},
		{
			...
			Type:                     "codebuddy-intl",
			DisplayName:              "DeepSeek V4 Flash",
			Description:              "DeepSeek V4 Flash via CodeBuddy International — fast, economical variant",
			ContextLength:            1000000,
			MaxCompletionTokens:      32000,
			InputTokenLimit:          1000000,
			OutputTokenLimit:         32000,
		...
		},
		{
			...
			Type:                     "codebuddy-intl",
			DisplayName:              "MiniMax 3",
			Description:              "MiniMax 3 via CodeBuddy International — latest generation",
			ContextLength:            200000,
			MaxCompletionTokens:      32000,
			InputTokenLimit:          200000,
			OutputTokenLimit:         32000,
